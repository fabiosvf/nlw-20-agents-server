...
export async function transcribeAudio(audioAsBase64: string, mimeType: string) {
  const response = await gemini.models.generateContent({
    ...
    contents: [
      {
        text: 'Transcreva o áudio para o português do Brasil. Seja preciso e natural na transcrição. Mantenha a pontuação adequeada e divida o texto em parágrafos quando for apropriado.',
      },
      {
        inlineData: {
          mimeType,
